...
public class RomanConverter{
	...
	static {
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(1000, "M"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(900, "CM"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(500, "D"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(400, "CD"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(100, "C"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(90, "XC"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(50, "L"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(40, "XL"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(10, "X"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(9, "IX"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(5, "V"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(4, "IV"));
		SYMBOLS.add(new RomanNumber().RomanNumberDefault(1, "I"));
	  }
